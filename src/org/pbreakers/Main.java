...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Infirmier> infirmiers = new List<Infirmier>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        List<Pharmacie> pharmacies = new List<Pharmacie>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        List<Pharmacien> pharmaciens = new List<Pharmacien>() {
            @Override
            public int size() {
                return 0;
            }
        ...
        List<Receptioniste> receptionistes = new List<Receptioniste>() {
            @Override
            public int size() {
                return 0;
            }
